    ...
    answerList = () => {
        mypage.listAnswer()
            .then(res => {
                ...
                console.log('answerList-Data----', res.data);
            })
            .catch(err => {
                console.log('answerList() Error!!', err);
            })
    }
            ...
            <div><br /><br />
                <form>
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {this.state.answerList.slice(page * rPage, page *
                                rPage + rPage).map((product) => (
                                    <TableRow hover key={product.num} onClick={this.answer.bind(this, product.num)}>
                        ...
                        <TableFooter>
                            <TableCell colSpan={7}>
                                <TablePagination
                                    ...
                                    component="div"
                                    count={this.state.answerList.length}
                                    rowsPerPage={rPage}
                                    page={page}
