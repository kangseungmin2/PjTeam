...
class anwserList extends Component {
    ...
    render() {
        return (
            ...
            <Container component="main" maxWidth="md">
                ...
                <Typography variant="h4" style={style}> 1:1문의 답변 </Typography>
                
                <Grid container spacing={2}>
                    
                    <Grid item md={12}>
                    <Button variant="contained" style={btn} color="primary" onClick={this.addBoard}>답변 </Button>
