...
// 자동이체 출금계좌 변경화면 
export default class alterAutoAccount extends Component {
  constructor(props) {
    super(props);
  ...
  clickBtn = (accountNum, accountPW) => {
    ...
    const strChageAccount = this.state.chageAccount;
    ...
    if (enteredPassword == accountPW) {
      if (strChageAccount != '') {
        ...
        window.localStorage.setItem('chageAccount', strChageAccount);
        API.this.props.history.push('/limitAccount');
      }
      else{
  ...
  render() {
    return (
      <div>
        ...
        <Typography variant="h4" style={style}> 자동이체 출금계좌 변경 </Typography>
        <br/>
        <Table>
              <TableHead>
                  <TableRow>
                  ...
                  <TableRow>
                    <TableCell align="center" width="100">기존 출금계좌</TableCell>
                    <TableCell align="center" width="100">{this.state.autos.accountNum}</TableCell>
                  </TableRow>

                  <TableRow>
                    <TableCell align="center" width="100">변경 계좌</TableCell>
                    <TableCell align="center" width="100">
                        <input
                        type="number"
                        id="accountNum"
                        name="accountNum"
                        value= {this.state.alterDate} 
