...
class pensionPay extends Component{
    constructor(props){
        super(props);
        this.state ={
            data:[],
                                ...
                                <TableCell style={{ textAlign: 'left', border: '1px solid rgb(230, 229, 227)' }}>
                                    <FormControl variant="standard" sx={{ m: 2, mt: 2, width: '50ch' }}>
                                        ...
                                        <Grid container spacing={1}>
                                            <Button style={{ margin: '10px' }} color="primary" variant="outlined" onClick={this.pwCheck}>비밀번호 확인</Button>
                                        </Grid>
                                    </FormControl>
                                </TableCell>
                            </TableRow>
